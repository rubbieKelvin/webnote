<template>
    <div class="overflow-clip select-none text-text bg-elevation md:min-w-[15%] md:max-w-[15%] py-4 px-5 hidden md:flex flex-col gap-12">
        <!-- ... -->
...
<style scoped>
.quick-link{
    @apply transition-all duration-200 ease-in-out rounded-md px-4 flex py-2 gap-3 items-center;
}
...
import BuyMeCoffee from '../utils/BuyMeCoffee.vue'
...
export default {
    ...
    components: {ProfileBanner, BuyMeCoffee},
    methods: {
        ...mapActions([
            'setNoteListMode'
        ]),
