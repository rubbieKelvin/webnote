<template>
    <div class="pt-4 pb-1 max-w-[50%] min-w-[50%] gap-3 flex flex-col">
        <div class=" px-2 flex gap-6" :class="[activeNote===null ? ' text-gray-400 pointer-events-none' : 'text-text']">
            <group-button label="File">
                ...
                <group-button-item :class="{'text-white bg-accent hover:bg-accent': noteseditmode}" @click="toggleEditMode()">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <group-button v-if="noteseditmode" label="Insert">
                ...
                <group-button-item>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.25 8.25C14.25 11.1495 11.8995 13.5 9 13.5M9 13.5C6.10051 13.5 3.75 11.1495 3.75 8.25M9 13.5V16.5M9 16.5H6M9 16.5H12M9 10.5C7.75736 10.5 6.75 9.49264 6.75 8.25V3.75C6.75 2.50736 7.75736 1.5 9 1.5C10.2426 1.5 11.25 2.50736 11.25 3.75V8.25C11.25 9.49264 10.2426 10.5 9 10.5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </group-button-item>
                <group-button-item>
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 16.5C4.85786 16.5 1.5 13.1421 1.5 9C1.5 4.85786 4.85786 1.5 9 1.5C13.1421 1.5 16.5 4.85786 16.5 9C16.4955 13.1403 13.1403 16.4955 9 16.5ZM9 3C5.68629 3 3 5.68629 3 9C3 12.3137 5.68629 15 9 15C12.3137 15 15 12.3137 15 9C14.9963 5.68783 12.3122 3.00372 9 3ZM12.75 9.75H8.25V5.25H9.75V8.25H12.75V9.75Z" fill="currentColor"/>
                    </svg>
                </group-button-item>
                <group-button-item :stroke="false">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.5 15L10.5 3M13.5 6L16.5 9L13.5 12M4.5 12L1.5 9L4.5 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </group-button-item>
            </group-button>
        </div>
    ...
    methods: {
        ...
        editorAddText(){
            ...
            if (note){
                ...
                content.push(makeText("text item..."))
                this.$store.commit("UPDATE_ACTIVE_NOTE", {content})
            }
        }
    }
}
