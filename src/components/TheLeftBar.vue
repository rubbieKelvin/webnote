<template>
    <div class=" hidden md:flex w-[15%] max-w-[15%] border-r flex-col border-stroke py-5">
        <!-- ... -->
        <div class="px-4 flex items-center justify-between">
            <profile-widget/>
            <tool-tip text="Create new note">
                <button class="h-6 w-6 flex items-center justify-center rounded-md text-white font-bold bg-accent">
                    +
                </button>
            </tool-tip>
        </div>
...
export default {
    components: {ProfileWidget, ToolTip, Support},
    mixins: [SidebarMixin]
}
</script>
