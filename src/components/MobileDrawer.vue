<template>
    <div class="component-root" :class="{'drawer-closed': !modelValue}">
        <div class="drawer">
            <div class="flex border-r h-full flex-col border-stroke py-5">
                <!-- ... -->
                <div class="px-4 flex flex-col">
                    <p class="text-4xl font-medium">Webnote</p>
                    <p class="text-sm">stuffsbyrubbie</p>
                </div>
                ...
                <!-- ... -->
                <div class="px-4 flex flex-col gap-[6px]">
                    <div :class="{'quick-link-active': $sidebar==''}" @click="setSidebar('')" class="quick-link">
                    ...
                    <div :class="{'quick-link-active': $sidebar=='favorite'}" @click="setSidebar('favorite')" class="quick-link">
                        <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div :class="{'quick-link-active': $sidebar=='shared'}" @click="setSidebar('shared')" class="quick-link">
                        <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div :class="{'quick-link-active': $sidebar=='trash'}" @click="setSidebar('trash')" class="quick-link">
                        <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="overlay" @mousedown="$emit('update:modelValue', false)"/>
    </div>
</template>
...
<style scoped>
.component-root{
    @apply absolute flex bg-black bg-opacity-20 z-50 top-0 bottom-0 left-0 right-0;
}

.component-root.drawer-closed{
    @apply hidden;
}

.drawer{
    @apply bg-white h-full flex-grow;
}
...
.quick-link{
    @apply font-medium flex gap-2 p-2 text-textFaint;
    @apply rounded-md select-none cursor-pointer;
    @apply hover:text-text hover:bg-hoverColor;
}

.quick-link-active{
    @apply bg-hoverColor text-accent hover:text-accent;
}
</style>